...
#define MUXIN1_PORT         GPIO_PORT_P2
#define MUXIN1_PIN          GPIO_PIN7

#define MUXIN0_PORT         GPIO_PORT_P2
#define MUXIN0_PIN          GPIO_PIN5

#define LIGHT_PORT         GPIO_PORT_P8
#define LIGHT_PIN          GPIO_PIN3
